...
@ApiTags('Notes Attachment Note SubCategory')
@Controller('note-attachment/note-subcategory')
export class NoteSubCategoryController {
  ...
  @Permissions(
    PermissionsEnum.SYSTEM_CONFIGURATION_OPERATIONS_ADMINISTRATION_NOTES_AND_ATTACHMENTS_NOTES_SUBCATEGORY_WRITE
  )
  ...
  // @Permissions(
  //   PermissionsEnum.SYSTEM_CONFIGURATION_OPERATIONS_ADMINISTRATION_NOTES_AND_ATTACHMENTS_NOTES_SUBCATEGORY_WRITE,
  //   PermissionsEnum.SYSTEM_CONFIGURATION_OPERATIONS_ADMINISTRATION_NOTES_AND_ATTACHMENTS_NOTES_SUBCATEGORY_READ
  // )
  async getAll(
  ...
  @UseGuards(PermissionGuard)
  @Permissions(
    PermissionsEnum.SYSTEM_CONFIGURATION_OPERATIONS_ADMINISTRATION_NOTES_AND_ATTACHMENTS_NOTES_SUBCATEGORY_ARCHIVE
  )
