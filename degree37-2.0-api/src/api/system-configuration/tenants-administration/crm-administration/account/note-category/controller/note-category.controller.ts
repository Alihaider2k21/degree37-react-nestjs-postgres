...
@ApiTags('Account Note Category')
@Controller('accounts/note-category')
export class NoteCategoryController {
  ...
  @Permissions(
    PermissionsEnum.SYSTEM_CONFIGURATION_CRM_ADMINISTRATION_ACCOUNTS_NOTES_CATEGORY_WRITE
  )
  ...
  // @UseGuards(PermissionGuard)
  // @Permissions(
  //   PermissionsEnum.SYSTEM_CONFIGURATION_CRM_ADMINISTRATION_ACCOUNTS_NOTES_CATEGORY_READ,
  //   PermissionsEnum.SYSTEM_CONFIGURATION_CRM_ADMINISTRATION_ACCOUNTS_NOTES_CATEGORY_WRITE
  // )
  async getAll(
  ...
  @UseGuards(PermissionGuard)
  @Permissions(
    PermissionsEnum.SYSTEM_CONFIGURATION_CRM_ADMINISTRATION_ACCOUNTS_NOTES_CATEGORY_ARCHIVE
  )
