...
@ApiTags('Location Note SubCategory')
@Controller('locations/note-subcategory')
export class NoteSubCategoryController {
  ...
  @Permissions(
    PermissionsEnum.SYSTEM_CONFIGURATION_CRM_ADMINISTRATION_LOCATIONS_NOTES_SUBCATEGORY_WRITE
  )
  ...
  // @Permissions(
  //   PermissionsEnum.SYSTEM_CONFIGURATION_CRM_ADMINISTRATION_LOCATIONS_NOTES_SUBCATEGORY_WRITE,
  //   PermissionsEnum.SYSTEM_CONFIGURATION_CRM_ADMINISTRATION_LOCATIONS_NOTES_SUBCATEGORY_READ
  // )
  async getAll(
  ...
  @UseGuards(PermissionGuard)
  @Permissions(
    PermissionsEnum.SYSTEM_CONFIGURATION_CRM_ADMINISTRATION_LOCATIONS_NOTES_SUBCATEGORY_ARCHIVE
  )
