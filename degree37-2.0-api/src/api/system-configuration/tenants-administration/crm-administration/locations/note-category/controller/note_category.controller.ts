...
@ApiTags('Location Note Category')
@Controller('locations/note-category')
export class NoteCategoryController {
  ...
  @Permissions(
    PermissionsEnum.SYSTEM_CONFIGURATION_CRM_ADMINISTRATION_LOCATIONS_NOTES_CATEGORY_WRITE
  )
  ...
  // @Permissions(
  //   PermissionsEnum.SYSTEM_CONFIGURATION_CRM_ADMINISTRATION_LOCATIONS_NOTES_CATEGORY_WRITE,
  //   PermissionsEnum.SYSTEM_CONFIGURATION_CRM_ADMINISTRATION_LOCATIONS_NOTES_CATEGORY_READ
  // )
  async getAll(
  ...
  @UseGuards(PermissionGuard)
  @Permissions(
    PermissionsEnum.SYSTEM_CONFIGURATION_CRM_ADMINISTRATION_LOCATIONS_NOTES_CATEGORY_ARCHIVE
  )
  async delete(@Param('id') id: number) {
    return this.noteCategoryService.deleteNoteCategory(id);
  }
}
