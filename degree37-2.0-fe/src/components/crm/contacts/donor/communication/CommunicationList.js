...
import DonorNavigation from '../../donors/DonorNavigation';
...
const CommunicationList = () => {
  ...
  useEffect(() => {
    context.setBreadCrumbsState([
      ...DonorBreadCrumbsData,
      {
        label: 'View Donor',
        class: 'disable-label',
        link: `/crm/contacts/donor/${params?.id}/view`,
      },
      {
        label: 'Communication',
        class: 'active-label',
        link: `/crm/contacts/donor/${params?.id}/view/communication`,
      },
    ]);
  }, []);
  ...
  return (
    <div className={styles.accountViewMain}>
      <DonorNavigation donor={context?.donor}>
