...
let navigateToMainPageLink = `/system-configuration/tenant-admin/crm-admin/${crmAdminType}/${categoryType}-categories/list`;

const EditContactsNoteCategory = () => {
  ...
  const confirmArchive = async () => {
    const result = await fetchData(`/contacts/note-category/${id}`, 'PATCH');
        ...
        <SuccessPopUpModal
          ...
          redirectPath={
            redirectToMainScreen
              ? '/system-configuration/tenant-admin/crm-admin/contacts/note-categories/list'
              : ''
          }
        />
        <SuccessPopUpModal
...
export default EditContactsNoteCategory;
