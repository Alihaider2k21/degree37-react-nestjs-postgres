...
const LocationsAttachmentSubCategoryCreate = () => {
  ...
  const fetchNoteCategories = async () => {
    ...
    if (result.ok || status_code === 200) {
      ...
      toast.error(`Error Fetching ${categoryType} Subcategories`, {
        autoClose: 3000,
      });
    }
  };
  ...
  const fieldNames = [
    ...
    {
      label: `${categoryTypeLabel} Subcategory`,
...
export default LocationsAttachmentSubCategoryCreate;
