    ...
    <div>
      ...
      <Container className={styles.container}>
        ...
        <Row className="w-100">
              ...
              {isLoading ? (
                <Card.Body className={styles.cardBody}>
                  <Row className={styles.cardRow}>
                    <Col
                      xs={12}
                      className={`${styles.supervisorCol} no-data d-flex justify-content-center align-items-center py-3`}
                    >
                      Data Loading
                    </Col>
                  </Row>
                ...
                <Card.Body className={styles.cardBody}>
                  <Row className={styles.cardRow}>
                    <Col xs={4} className={styles.roleNameCol}>
                      Ad Type
                    </Col>
              ...
              {isLoading ? (
                ...
                <Card.Body className={styles.cardBody}>
                  <Row className={styles.cardRow}>
                    ...
                    <Col xs={8} className={styles.supervisorCol}>
                      <span className={`${styles.active} ${styles.badge}`}>
                        Active
                      </span>
                    </Col>
                  </Row>
                  ...
                  <Row className={styles.cardRow}>
                    ...
                    <Col xs={8} className={styles.supervisorCol}>
                      ...
                      {adsViewData?.created_at
                        ? formatDate(adsViewData?.created_at)
                        : 'N/A'}
                    </Col>
                  </Row>
                  <div className={styles.divider}></div>
                  <Row className={styles.cardRow}>
                    ...
                    <Col xs={8} className={styles.supervisorCol}>
                      {adsViewData?.modified_by || adsViewData?.created_by
                        ? formatUser(
                            adsViewData?.modified_by ?? adsViewData?.created_by
                          )
                        : 'N/A |'}{' '}
                      {adsViewData?.modified_at || adsViewData?.created_at
                        ? formatDate(
                            adsViewData?.modified_at ?? adsViewData?.created_at
                          )
                        : 'N/A'}
          ...
          {!isLoading && (
            <Col className={styles.imageContainer} lg={6} md={8}>
              <div className={`${styles.adviewimg}`}>
                <img
                  alt=""
                  width={509}
                  height={320}
                  className={`${styles.viewadsimg} image-fluid`}
                  src={adsViewData?.image_url}
                />
              </div>
            </Col>
          )}
