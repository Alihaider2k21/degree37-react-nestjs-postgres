...
let navigateToMainPageLink = `/system-configuration/tenant-admin/operations-admin/${crmAdminType}/${categoryType}-categories`;

const EditNotesAndAttachmentCategory = () => {
  ...
  useEffect(() => {
    const fetchFormData = async (id) => {
      if (id) {
        let url = `/notes-attachments/attachment-categories/${id}`;
  ...
  return (
    <div className="mainContent">
      ...
      <div className="mainContentInner form-container">
        ...
        <SuccessPopUpModal
          title="Success!"
          message={`${categoryTypeLabel} Category is archived.`}
...
export default EditNotesAndAttachmentCategory;
